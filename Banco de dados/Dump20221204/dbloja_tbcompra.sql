...
CREATE TABLE `tbcompra` (
  ...
  KEY `idCliente_tbCliente` (`idCliente_tbCliente`),
  CONSTRAINT `tbcompra_ibfk_1` FOREIGN KEY (`idCliente_tbCliente`) REFERENCES `tbcliente` (`idCliente`) ON DELETE CASCADE ON UPDATE CASCADE
...
INSERT INTO `tbcompra` VALUES (1,1);
